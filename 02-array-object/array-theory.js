...
// const reversed = names.toReversed() - не изменяет исходный массив
// const letters = ['e', 'c', 'd', 'b', 'a']
// console.log(letters.toSorted()) - не изменяет исходный массив
// console.log(letters)

// console.log(names.splice(0, 2))
// console.log(names.toSpliced(0, 2)) - не изменяет исходный массив
// console.log(names)

// const greateWoman = 'Елена'
// const index = names.indexOf(greateWoman)
// console.log(index)
// const newNames = names.with(index, 'Елена Великая') - не изменяет исходный массив, заменяет значение по index на новое значение
...
//метод map используется для модификации элементов
